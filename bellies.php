...
.b{
		background-image: url("https://previews.123rf.com/images/olehphotographer/olehphotographer1704/olehphotographer170400016/75877162-red-women-s-shoes-ballerinas-on-wooden-background-selective-focus-.jpg");
  width:100%;
  height: auto; 
...
include ("config.php");
session_start();
$q1="select * from products where cat_id=2 and sub_cat_id=6";
$run_q= mysqli_query($con,$q1);
  ...
  <div class='gallery'>
      <img src='footwear/bellies/$i.jpg'>
