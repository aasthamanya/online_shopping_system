...
.b{
		background-image: url("https://cdn.wallpapersafari.com/52/73/Psu3ve.jpg");
  width:100%;
  height: auto; 
...
include ("config.php");
session_start();
$q1="select * from products where cat_id=2 and sub_cat_id=7";
